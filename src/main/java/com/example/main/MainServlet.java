...
public class MainServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if ("singout".equals(action)) { // ログアウト
			...
			List<Acount> acounts = acountDAO.searchAndSortAcounts(searchTerm);
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if ("eventAdd".equals(action)) { // イベント追加
			...
			int reservationId = Integer.parseInt(req.getParameter("reservation_id"));
			if (!acountDAO.getActiveAcount().getReservationDAO().deleteReservation(reservationId)) {
